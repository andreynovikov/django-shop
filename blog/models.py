...
# Taken from https://github.com/Fantomas42/django-blog-zinnia/blob/develop/zinnia/url_shortener/backends/default.py
...
class Entry(models.Model):
    ...
    tags = TagField(verbose_name='тэги')
