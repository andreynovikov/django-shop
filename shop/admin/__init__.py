...
class ProductAdmin(ImportExportMixin, admin.ModelAdmin):
    ...
    list_filter = ['enabled', 'show_on_sw', 'avito', 'beru', 'market', 'isnew', 'recomended',
    ...
    fieldsets = (
        ...
        ('Маркетинг', {
            'classes': ('collapse', 'suit-tab', 'suit-tab-money'),
            'fields': (('enabled', 'show_on_sw', 'firstpage'), ('merchant', 'market', 'beru', 'avito'), ('isnew', 'recomended', 'gift'), 'credit_allowed', 'deshevle',
